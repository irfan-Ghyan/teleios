...
const Coaching = () => {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden lg:h-[750px] xl:h-[850px] bg-cover bg-right xl:bg-center px-4" style={{ backgroundImage: "url('/assets/images/experience/S7.jpg')" }}>
        <div className='w-full bg-[#11072C] bg-opacity-80 xl:bg-opacity-0 px-4'>
