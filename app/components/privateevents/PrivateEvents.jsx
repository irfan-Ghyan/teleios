...
const PrivateEvents = () => {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden lg:h-[750px] xl:h-[850px] bg-cover bg-left xl:bg-center px-4" style={{ backgroundImage: "url('/assets/images/experience/S6-new1.jpg')" }}>
      <div className='w-full px-4 bg-[#11072C] bg-opacity-80 lg:bg-opacity-0 md:bg-opacity-60 xl:bg-opacity-0'>
