    ...
    >
      <button
        ...
        css={[
          carouselBtn,
          carouselBtnLeft,
          theme === "light" ? carouselBtnLight : carouselBtnDark,
        ]}
        role="button"
        ...
        style={{
          ...carouselBtnStyle,
          ...carouselBtnLeftStyle,
          ...(theme === "light" ? carouselBtnLightStyle : carouselBtnDarkStyle),
        }}
      >
        <svg
      ...
      <Slider
        ...
        customPaging={(i) => (
          <button tabIndex={0} aria-label={`Review ${i + 1}`}>
            {i + 1}
          </button>
        )}
        responsive={[
        ...
        {reviews.map((review, index) => (
          ...
          >
            <ReviewCard
              ...
              theme={theme}
              reviewCardClassName={reviewCardClassName}
              reviewCardStyle={reviewCardStyle}
              reviewCardLightClassName={reviewCardLightClassName}
              reviewCardLightStyle={reviewCardLightStyle}
              reviewCardDarkClassName={reviewCardDarkClassName}
              reviewCardDarkStyle={reviewCardDarkStyle}
              reviewBodyCardClassName={reviewBodyCardClassName}
              reviewBodyCardStyle={reviewBodyCardStyle}
              reviewBodyTestimonialClassName={reviewBodyTestimonialClassName}
              reviewBodyTestimonialStyle={reviewBodyTestimonialStyle}
              reviewTextClassName={reviewTextClassName}
              reviewTextStyle={reviewTextStyle}
              reviewTextLightClassName={reviewTextLightClassName}
              reviewTextLightStyle={reviewTextLightStyle}
              reviewTextDarkClassName={reviewTextDarkClassName}
              reviewTextDarkStyle={reviewTextDarkStyle}
              reviewReadMoreClassName={reviewReadMoreClassName}
              reviewReadMoreStyle={reviewReadMoreStyle}
              reviewReadMoreLightClassName={reviewReadMoreLightClassName}
              reviewReadMoreLightStyle={reviewReadMoreLightStyle}
              reviewReadMoreDarkClassName={reviewReadMoreDarkClassName}
              reviewReadMoreDarkStyle={reviewReadMoreDarkStyle}
              reviewFooterClassName={reviewFooterClassName}
              reviewFooterStyle={reviewFooterStyle}
              reviewerClassName={reviewerClassName}
              reviewerStyle={reviewerStyle}
              reviewerProfileClassName={reviewerProfileClassName}
              reviewerProfileStyle={reviewerProfileStyle}
              reviewerProfileImageClassName={reviewerProfileImageClassName}
              reviewerProfileImageStyle={reviewerProfileImageStyle}
              reviewerProfileFallbackClassName={reviewerProfileFallbackClassName}
              reviewerProfileFallbackStyle={reviewerProfileFallbackStyle}
              reviewerNameClassName={reviewerNameClassName}
              reviewerNameStyle={reviewerNameStyle}
              reviewerNameLightClassName={reviewerNameLightClassName}
              reviewerNameLightStyle={reviewerNameLightStyle}
              reviewerNameDarkClassName={reviewerNameDarkClassName}
              ...
              reviewerDateLightClassName={reviewerDateLightClassName}
              reviewerDateLightStyle={reviewerDateLightStyle}
              reviewerDateDarkClassName={reviewerDateDarkClassName}
